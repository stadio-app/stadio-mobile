        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'authPlatform' },
                },
              ],
            },
          },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'authStateId' } },
              ],
            },
          },
        ],
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'resendEmailVerificationCode' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'email' },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'token' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'authStateId' },
                      },
                    ],
                  },
                },
...
export const GoogleOauthDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GoogleOauth' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GoogleOauthQuery, GoogleOauthQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'AllEventsFilter' },
            },
          },
        },
      ],
